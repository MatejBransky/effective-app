/**
 * Compile-time drift check between packages/db's hand-written Drizzle tables and
 * packages/schema's Effect Schema entities - catches divergence at `tsc --noEmit`
